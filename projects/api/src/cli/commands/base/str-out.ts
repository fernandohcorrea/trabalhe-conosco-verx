...
export default class StrOut {
   ...
   * @returns StrOut
   */
  outSuccess(str: string, new_line = true) {
   ...
   * @returns StrOut
   */
  outDanger(str: string, new_line = true) {
   ...
   * @returns StrOut
   */
  outInfo(str: string, new_line = true) {
   ...
   * @returns StrOut
   */
  outWarning(str: string, new_line = true) {
